...
- **Versions-Bump:** der `serverVersion` in `createMcpServer` ist aktuell hardcoded `'1.2.1'`. Bei jeder Release sollten wir das auf die aktuelle `package.json#version` synchronisieren — TODO als kleiner Folge-Refactor.
